...
@description Rotina responsável pela atualização das informações de Envio do Pedido E-Commerce para a transportadora.
...
User Function UNIWS009( cParamEmpJob, cParamFilJob, cParamInstancia, oParamWS, cParamNumLoteLog )
	*-----------------------------------------------------------------------------------------------*
	...
	Local cTitulo   	    := "Integração Protheus x Magento - Envio do Pedido para Transportadora"
	Local cTexto       		:= "<font color='red'> Integração Protheus x Magento </font><br> Esta rotina tem como objetivo de atualizar o Status do Pedido no Magento, enviando o mesmo para Transportadora.<br>Informe o Pedido a ser atualizado na opção de <b>Parâmetros</b> e confirme a rotina."
	...
	*----------------------------------------------------------*
	...
	Do While !( cAliasQry )->( Eof() )
		...
		If lProssegue
			...
			// Verifica se já criou o Id de Rastreabilidade do Frete no Magento
